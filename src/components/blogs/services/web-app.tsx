...
export default function WebApp() {
  return (
    <div className="flex flex-col items-center justify-center w-full overflow-hidden text-gray-900 bg-gradient-to-b from-white to-orange-50/20">
      ...
      <section className="w-full max-w-5xl px-4 mx-auto my-4">
      ...
      <section className="w-full max-w-5xl px-4 mx-auto">
        ...
        <div className="mb-32">
          <div className="flex flex-col items-center justify-center w-full max-w-2xl pt-24 mx-auto">
            ...
            <h1 className="mb-8 text-4xl font-medium text-center text-gray-800">
              Mengapa Memiliki Aplikasi Web Itu Penting?
            </h1>
            <p className="max-w-md mb-12 text-sm text-center text-gray-600">
              Aplikasi web adalah solusi komprehensif untuk bisnis di era
              digital. Tidak hanya meningkatkan efisiensi operasional, aplikasi
              web juga memungkinkan interaksi yang lebih kaya dengan pelanggan,
              otomatisasi proses bisnis, dan memberikan keunggulan kompetitif
              melalui layanan yang dapat diakses kapanpun.
            </p>
          </div>
        ...
        <div className="mb-20">
          <div className="flex flex-col items-center justify-center w-full max-w-2xl mx-auto mb-12">
            ...
            <p className="max-w-md text-center text-gray-600">
              Kami adalah tim profesional yang berpengalaman dalam pengembangan
              aplikasi web untuk kebutuhan bisnis Anda.
            </p>
          </div>
          ...
          <div className="p-8 bg-white rounded-xl">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {[
                {
                  title: 'E-Commerce',
                  desc: 'Platform jual beli online dengan sistem pembayaran dan manajemen produk',
                  icon: <TrendingUp className="w-5 h-5 text-orange-500" />,
                },
                {
                  title: 'Portal Berita',
                  desc: 'Sistem manajemen konten untuk publikasi artikel dengan kategori',
                  icon: <Search className="w-5 h-5 text-orange-500" />,
                },
                {
                  title: 'E-Learning',
                  desc: 'Platform pembelajaran online dengan manajemen kursus dan materi',
                  icon: <Users className="w-5 h-5 text-orange-500" />,
                },
                {
                  title: 'Manajemen Data',
                  desc: 'Aplikasi untuk mengelola data bisnis dengan dashboard analitik',
                  icon: <Box className="w-5 h-5 text-orange-500" />,
                },
                {
                  title: 'Sistem Reservasi',
                  desc: 'Platform booking online dengan kalender dan notifikasi',
                  icon: <Clock className="w-5 h-5 text-orange-500" />,
                },
                {
                  title: 'Custom Web App',
                  desc: 'Solusi khusus sesuai kebutuhan unik bisnis Anda',
            ...
            <div className="relative p-8 mt-12 overflow-hidden border-[.5px] border-orange-100 bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl">
              ...
              <div className="relative z-10">
                <p className="text-xl italic font-medium leading-relaxed text-gray-700">
                  &quot;Kami membangun solusi bisnis digital yang membantu Anda
                  mencapai tujuan dengan teknologi tepat guna.&quot;
                </p>
